...
describe('PokemonsService', () => {
  ...
  it('get pokemons', inject([PokemonsService], () => {
    expect(pokemonsService.pokemons$).toBe(testData.pokemons);
  }));

  it('get catchedPokemons', () => {
    expect(pokemonsService.catchedPokemons$).toBe(testData.catchedPokemons);
  });
